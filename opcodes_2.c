...
/**
 *sub - subtracts the topmost element from second topmost
 *element
 *@stack:pointer
 *@ln:line no
 *Return:void
...
/**
 *div_op - divides the second topmost element by the top element
 *@stack:pointer
 *@ln:line no
 *Return:void
 */
...
/**
 *mul - multiplies the second top elment with the top
 *element
 *@stack:pointer
 *@ln: line no
 *Return:void
